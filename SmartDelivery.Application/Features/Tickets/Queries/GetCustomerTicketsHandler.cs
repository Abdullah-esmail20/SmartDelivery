...
public class GetCustomerTicketsHandler
    : IRequestHandler<GetCustomerTicketsQuery, IEnumerable<TicketDto>>
{
    private readonly ITicketRepository _ticketRepository;

    public GetCustomerTicketsHandler(ITicketRepository ticketRepository)
    {
